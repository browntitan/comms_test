<script lang="ts">
	...
	export let useCaseGuidance: string = '';
	export let prompt: string = ''; // now exported for two-way binding
	export let files: any[] = [];   // likewise, export files
	...
	onMount(async () => {
		...
		if (!chatIdProp && !prompt && useCaseGuidance) {
